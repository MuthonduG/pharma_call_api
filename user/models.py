...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    pharma_id = models.CharField(max_length=256, editable=False)
...
# check password and create a username && pharma_id before saving the user
@receiver(pre_save, sender=User)
def pre_save_user(sender, instance, **kwargs):
    if not instance.pharma_id or instance.has_changed(['email', 'security_query_response']):
